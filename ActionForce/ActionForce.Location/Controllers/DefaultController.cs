...
namespace ActionForce.Location.Controllers
{
    public class DefaultController : BaseController
    {
        ...
        public PartialViewResult CreateOrder(FormOrder neworder)
        {
            ...
            if (neworder != null)
            {
                DateTime date = DateTime.UtcNow.AddHours(model.Location.Timezone.Value).Date;
                ...
                LocationHelper.AddApplicationLog("Location", "TicketSale", "Insert", orderID.ToString(), "Default", "CreateOrder", null, true, $"{OrderNumber} Nolu Sipariş Eklendi", string.Empty, DateTime.UtcNow.AddHours(model.Location.Timezone.Value), $"{model.Authentication.CurrentEmployee.EmployeeID} {model.Authentication.CurrentEmployee.FullName}", LocationHelper.GetIPAddress(), string.Empty, null);
