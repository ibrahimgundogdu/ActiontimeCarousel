...
namespace ActionForce.Office.Controllers
{
    public class CashController : BaseController
    {
        ...
        [AllowAnonymous]
        public ActionResult AddSale(Guid? id)
        {
            CashControlModel model = new CashControlModel();
        ...
        [AllowAnonymous]
        public ActionResult AddExchange(Guid? id)
        {
            CashControlModel model = new CashControlModel();
        ...
        [AllowAnonymous]
        public ActionResult AddOpen(Guid? id)
        {
            CashControlModel model = new CashControlModel();
        ...
        [AllowAnonymous]
        public ActionResult AddExpense(Guid? id)
        {
            CashControlModel model = new CashControlModel();
        ...
        [AllowAnonymous]
        public ActionResult AddBankTransfer(Guid? id)
        {
            CashControlModel model = new CashControlModel();
        ...
        public ActionResult EditSalaryPayment(EditCashSalaryPayment cashSalary)
        {
            ...
            if (cashSalary != null)
            {
                ...
                if (amount > 0)
                {
                    ...
                    salarypay.FromBankID = null;
                    salarypay.FromCashID = cash.ID;
